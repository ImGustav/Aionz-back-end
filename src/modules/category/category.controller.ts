...
export class CategoryController {
   ...
   */
  @Post()
  create(@Body() createCategoryDto: CreateCategoryDto): Promise<ResponseCategory> {
   ...
   */
  @Patch(':id')
  update(@Param('id', ParseIntPipe) id: number, @Body() updateCategoryDto: UpdateCategoryDto): Promise<ResponseCategory> {
